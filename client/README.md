...
Running the application: After extracting the zip file, from the project directory start the server by running 'nodemon'. From another terminal window start the client by running 'cd client' and 'npm install' then 'npm start'. Your application should run on http://localhost:3000.

The finished version of the app can be found on: https://react-rest-api.herokuapp.com/
